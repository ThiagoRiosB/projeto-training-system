  ...
  <v-app theme="dark" id="background">
        <v-main>         
          <v-container  class="d-flex justify-center justify-md-end h-screen align-center">
            <v-form ref="form" style="width: 40%; background-color: rgba(97, 90, 90, 0);" class="d-flex flex-column border rounded elevation-2 pa-5" @submit.prevent="handleSubmit">
              ...
              <v-card-actions>
               ...
               <v-btn variant="outlined" color="orange-accent-3" type="submit"><router-link class="text-decoration-none text-orange" to="/">Voltar</router-link></v-btn>      
              </v-card-actions>       
             </v-form>
          </v-container>
        </v-main>
