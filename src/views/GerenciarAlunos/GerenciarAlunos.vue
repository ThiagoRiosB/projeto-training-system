    ...
    <v-main class="ma-15">
      <v-container>
        <div class="d-flex justify-space-between">
          ...
          <div>
            <v-btn variant="outlined" color="orange"><router-link class="text-decoration-none text-white" to="/cadastrar-aluno">Novo</router-link></v-btn>
          </div>
        </div>
        <v-divider class="my-3"></v-divider>
        <div class="d-flex">
              ...
              <v-table density="compact">
                <thead>
                  ...
                  <tbody v-if="studentsName.students">
                    <tr v-for="studentsNames in nomesFiltrados" :key="studentsNames.id">
                      <td class="pa-1">
                      <v-btn variant="outlined" color="orange" class="mr-4" @click="() => redirectCadastrarTreino(studentsNames)">Montar treino</v-btn>
                      <v-btn variant="outlined" color="orange" @click="() => redirectVizualizarTreino(studentsNames)">Ver</v-btn>
                    </td>
                    </tr>
                  </tbody>
                </thead>
