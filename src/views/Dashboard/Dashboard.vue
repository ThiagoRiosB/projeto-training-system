        ...
        <v-row class="d-flex justify-center mt-10">
          ...
          <v-col cols="12" md="4" lg="3">
            <v-card color="orange" style="width: 300px;" variant="outlined" class="d-flex flex-column">
                ...
                <v-text class="pa-2 text-white text-center">{{ dashboardInfo.amount_exercises }} Exercícios cadastrados</v-text>
                    <v-btn color="orange" class="bg-orange-accent-3" variant="outlined"><router-link class="text-decoration-none text-white" to="/gerenciar-exercicios">
                    Adicionar</router-link>
                   </v-btn>
          </v-card>
          </v-col>
